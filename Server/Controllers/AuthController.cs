...
public class AuthController : ControllerBase
{
    ...
    public async Task<ActionResult<AuthToken?>> Login(UserLogin request)
    {
        ...
        result.IfSucc(async f =>
        {
            ...
            var id = new ClaimsIdentity(claim, CookieAuthenticationDefaults.AuthenticationScheme, "user", "role"); // TODO this is wrong... learn from https://github.com/dotnet/aspnetcore/blob/main/src/Security/samples/ClaimsTransformation/Controllers/AccountController.cs
